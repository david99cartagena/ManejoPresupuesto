...
namespace ManejoPresupuesto.Controllers
{
    ...
    {
        private readonly IRepositorioTiposCuenta repositorioTiposCuentas;
        ...
        public async Task<IActionResult> Ordenar([FromBody] int[] ids)
        {
            ...
            var tipoCuentasOrdenadas = ids.Select((valor, indice) =>
                new TipoCuenta() { Id = valor, Orden = indice + 1 }).AsEnumerable();

            await repositorioTiposCuentas.Ordenar(tipoCuentasOrdenadas);
