    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Index(PaginacionViewModel paginacionViewModel)
        {
            ...
            var respuestaVM = new PaginacionRespuesta<Categoria>
            {
                ...
                //Uso de Url.Action() para obtener la URL base de la acción actual
                BaseURL = Url.Action()
            };
        ...
        public async Task<IActionResult> Crear(Categoria categoria)
        {
            ...
            categoria.UsuarioId = usuariosId;
        ...
        {
            var usuariosId = servicioUsuarios.ObtenerUsuarioId();
            var categoria = await repositorioCategorias.ObtenerPorId(id, usuariosId);
